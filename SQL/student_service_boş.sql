...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 16 Eyl 2015, 00:23:26
...
--
ALTER TABLE `arac`
ADD CONSTRAINT `arac_ibfk_1` FOREIGN KEY (`PERSONEL_ID`) REFERENCES `personel` (`ID`) ON DELETE SET NULL ON UPDATE SET NULL;
...
--
ALTER TABLE `ogrenci`
ADD CONSTRAINT `ogrenci_ibfk_1` FOREIGN KEY (`ARAC_ID`) REFERENCES `arac` (`ID`) ON DELETE SET NULL ON UPDATE SET NULL,
ADD CONSTRAINT `ogrenci_ibfk_2` FOREIGN KEY (`OKUL_ID`) REFERENCES `okul` (`ID`) ON DELETE SET NULL ON UPDATE SET NULL;
...
--
ALTER TABLE `taksit`
ADD CONSTRAINT `taksit_ibfk_1` FOREIGN KEY (`OGRENCI_ID`) REFERENCES `ogrenci` (`ID`) ON DELETE SET NULL ON UPDATE SET NULL;
