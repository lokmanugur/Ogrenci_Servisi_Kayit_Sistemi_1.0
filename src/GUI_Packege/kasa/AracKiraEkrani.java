 ...
 */
public class AracKiraEkrani extends javax.swing.JInternalFrame {
...
jxDate dt = new jxDate();
     ...
     * @param aracko
     */
    public AracKiraEkrani(DbConnection databs,AracKiraOde aracko) {
       this.databs=databs;
       this.aracko=aracko;
       initComponents();
...
//        tte.setCustomTitles(str);
    ...
    private void secilenRow()
    {
        ...
        aracko.filTable((int)maastablo.getModel().getValueAt(maastablo.getSelectedRow(),0));
        aracko.show(true);
    }
...
"    P.ID = a.PERSONEL_ID AND \n";
    ...
    {
    firTable+=" AND p.ADI LIKE '"+SOFORADI.getText()+"%'";
    }
    try {   
        databs.openDatabase();
