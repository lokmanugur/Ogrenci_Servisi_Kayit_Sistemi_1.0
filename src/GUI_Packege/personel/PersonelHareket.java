 ...
 * @author zehirugur
 */
public class PersonelHareket extends javax.swing.JInternalFrame {
ReinstalData rid=new ReinstalData();
DbConnection databs;
PersonelKayit internalF;
MaasOde mo;
...
/**
     ...
     * @param mo
     */
    public PersonelHareket(PersonelKayit jif,DbConnection databs,MaasOde mo) {
       this.databs=databs;
       this.internalF=jif;
       this.mo=mo;
        initComponents();
...
firTable+=" AND p.SOYADI LIKE '"+SOYADI.getText()+"%'";
    ...
    try { 
        ...
        PERSONEL_TABLO.setModel(DbUtils.resultSetToTableModel(rs));  
...
if(-1==PERSONEL_TABLO.getSelectedRow()){
    JOptionPane.showMessageDialog(rootPane, "Lütfen Bilgilerini Değiştirmek istediğiniz Personeli Seçiniz.");
}else{
    internalF.ID=PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),0);
    internalF.ADI.setText((String)PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),1));
    internalF.SOYADI.setText((String)PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),2));
    internalF.jComboGorev.setSelectedItem(PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),3));
    internalF.TLF.setText((String)PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),4));
    internalF.ADRES.setText((String)PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),5));
    ...
    private void Exel_YazActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Exel_YazActionPerformed
        ...
        {
         TableToExcel tte = new TableToExcel(PERSONEL_TABLO, null, "My Table");
//        tte.setCustomTitles(str);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        mo.filTable((int)PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),0));
        mo.show(true);        
    }//GEN-LAST:event_jButton1ActionPerformed
    private void getSil()
    {
  if(PERSONEL_TABLO.getSelectedRow()!=-1){
     int result = JOptionPane.showOptionDialog(null, 
     (String)PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),1)+" "+(String)PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),2)+" S�L�NECEK! S�LMEK istedi�inize eminmisiniz.", 
     "Feedback", 
     ...
     {
databs.openDatabase();   
String sqlAccess="UPDATE personel SET IPTAL=1 WHERE ID="+PERSONEL_TABLO.getModel().getValueAt(PERSONEL_TABLO.getSelectedRow(),0)+"";
try
{
